...
const Navbar = ({ currentSection, scrollToSection, isFixed }) => {
  ...
  const handleInstagramClick = () => window.open("https://www.instagram.com/coach_fitness_fb", "_blank")
  const handleTikTokClick    = () => window.open("https://www.tiktok.com/@coach.98fitness", "_blank")
  const handleFacebookClick  = () => window.open("https://www.facebook.com/fa.res.648560", "_blank")
    ...
    >
      ...
      <div className="flex items-center justify-between h-20 px-4 max-w-7xl mx-auto">
        ...
        <div className="w-16 flex-shrink-0">
          <img className="rounded-2xl ring-2 ring-violet-700/40 shadow-lg shadow-violet-900/30" src={assets.Logo} alt="logo" />
        </div>
        ...
        <div className="flex items-center gap-3">
          <img onClick={handleFacebookClick}  className="rounded-xl w-8 h-8 cursor-pointer hover:shadow-md hover:shadow-blue-500 transition hover:scale-110" src={assets.Facebook}  alt="facebook"  />
          <img onClick={handleInstagramClick} className="rounded-xl w-8 h-8 cursor-pointer hover:shadow-md hover:shadow-pink-500 transition hover:scale-110" src={assets.instagram} alt="instagram" />
          <img onClick={handleTikTokClick}    className="rounded-xl w-8 h-8 cursor-pointer hover:shadow-md hover:shadow-gray-400 transition hover:scale-110" src={assets.tiktok}    alt="tiktok"    />
            ...
            {NavbarMenu.map((item) => {
              ...
              return (
                <li key={item.id}>
                  <button
                    type="button"
                    className={`block w-full text-left px-4 py-3 rounded-xl transition-all text-sm
