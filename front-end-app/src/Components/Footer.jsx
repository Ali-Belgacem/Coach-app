          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
              <img
                src={assets.Logo}
                alt="Coach Fares"
                className="w-12 rounded-xl ring-2 ring-violet-700/40"
              />
            ...
            <div className="flex gap-3 mt-2">
              <a
                href="https://www.facebook.com/fa.res.648560"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://www.instagram.com/coach_fitness_fb"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://www.tiktok.com/@coach.98fitness"
                target="_blank"
                rel="noreferrer"
              ...
              {links.map((l) => (
                <li key={l.id}>
                  <button
                    ...
                    className="text-gray-400 hover:text-violet-300 transition text-sm text-start"
                  >
                    {l.label}
                  </button>
                </li>
